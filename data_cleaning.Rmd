...
We found an interesting fact that more fighters in red corner win in comparison with blue corner. This is actually all winners before 2010 are recorded as red. We don't want this kind of unbalanced response variable, so we will switch the two sides and use them as new observations.
